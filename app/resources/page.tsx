    ...
    <AppLayout>
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-konekt-black mb-4">Knihovna</h1>
          <p className="text-lg text-konekt-black/60 mb-8 max-w-2xl mx-auto">
            Přístup k materiálům z workshopů, užitečným článkům, tutoriálům
            a další vzdělávací obsah pro rozvoj tvých skills.
          </p>

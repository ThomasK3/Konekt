            ...
            <div className="space-y-4">
              {userProjects.length > 0 ? (
                userProjects.map((project) => (
                  <div
                    key={project.id}
                    className="p-6 bg-konekt-white rounded-2xl border-2 border-konekt-black/10 hover:border-konekt-green hover:shadow-lg transition-all"
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
              ...
              <Link href="/feed">
                <button className="w-full p-6 bg-konekt-white rounded-2xl border-2 border-konekt-black/10 hover:border-konekt-green hover:shadow-lg transition-all flex items-center gap-4 group">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-konekt-black/60">Procházej profily</div>
                  </div>
                </button>
              </Link>
              ...
              <Link href="/messages">
                <button className="w-full p-6 bg-konekt-white rounded-2xl border-2 border-konekt-black/10 hover:border-konekt-pink hover:shadow-lg transition-all flex items-center gap-4 group">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-konekt-black/60">Začni konverzaci</div>
                  </div>
                </button>
              </Link>
              ...
              <Link href="/projects/new">
                <button className="w-full p-6 bg-konekt-white rounded-2xl border-2 border-konekt-black/10 hover:border-konekt-green hover:shadow-lg transition-all flex items-center gap-4 group">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-konekt-black/60">Sdílej svůj nápad</div>
                  </div>
                </button>
              </Link>
              ...
              <Link href="/events">
                <button className="w-full p-6 bg-konekt-white rounded-2xl border-2 border-konekt-black/10 hover:border-konekt-pink hover:shadow-lg transition-all flex items-center gap-4 group">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-konekt-black/60">Objevuj akce</div>
                  </div>
                </button>
              </Link>
            </div>
